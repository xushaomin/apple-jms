...
public abstract class TopicTextMessageConsumer extends MessageConusmer<String> {

	private static Logger logger = Logger.getLogger(TopicTextMessageConsumer.class);
