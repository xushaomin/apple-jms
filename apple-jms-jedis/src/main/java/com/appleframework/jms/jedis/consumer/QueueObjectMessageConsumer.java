...
public abstract class QueueObjectMessageConsumer extends MessageConusmer<Object> {

	private static Logger logger = Logger.getLogger(QueueObjectMessageConsumer.class);
