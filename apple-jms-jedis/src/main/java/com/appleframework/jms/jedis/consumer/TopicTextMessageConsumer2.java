...
public class TopicTextMessageConsumer2 {

	private static Logger logger = Logger.getLogger(TopicTextMessageConsumer2.class);
	...
	private BinaryJedisPubSub pubSub = new BinaryJedisPubSub() {
		...
		public void onMessage(byte[] channel, byte[] message) {
			messageConusmer2.processMessage(new String(message));
		}
